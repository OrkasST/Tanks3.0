export class Animation {
    constructor({
      ...
      if (this.log) console.log("ON CONSTRUCTING >>>>> this.currentFrame: ",this.currentFrame);
    }
  
    frame({deltaTime, rotation=-1, number}) {
      if (this.log) {
        console.log('deltaTime: ', deltaTime);
      console.log('ON FRAME >>>>> this.currentFrame: ', this.currentFrame);
